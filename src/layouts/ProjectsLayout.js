                ...
                >
                    ...
                    >
                        ...
                        >
                            <p className="mb0-00
                                lh-copy  tj"
                            >
                                Projects are magni impedit a atque earum officia iusto et reprehenderit tenetur iusto et reprehenderit tenetur nesciunt iusto et reprehenderit tenetur vero ratione pariatur odit omnis in temporibus.
                            </p>
                            <p className="mb0-00 
                                lh-copy tj"
                            >
                    ...
                    >
                        ...
                        >
                            ...
                            <li>
                                <NavLink to = "project-category-one"
                            ...
                            <li>
                                <NavLink to = "project-category-two"
                                    className="dib white-90 mb0-50"
                                
                                >
                                    Project Category Two
                                </NavLink>
                            </li>

                            <li>
                                <NavLink to= "project-category-three"
                                    className="dib white-90 mb0-50"
                                    
                                >
                                    Project Category Three
                                </NavLink>
                            </li>
                        </ul>
                    </nav>
